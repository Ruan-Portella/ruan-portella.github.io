                        ...
                        <Col xs={12} md={6} xl={7}>
                            <div>
                                ...
                                <p>
                                   ...
                                   <Button className={`currBtn ${isDark ? '' : 'currBtnLight'}`}  variant='dark'><a href="https://drive.google.com/file/d/1ywRFaazuhMUXRCJdWNaABpcmp_RBtb3R/view?usp=sharing" target="blank">{isBR ? 'Meu Currículo' : 'My Curriculum'}</a></Button>
                                </motion.div>
                            </div>
                        </Col>
                        <Col xs={12} md={6} xl={5}>
